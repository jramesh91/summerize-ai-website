  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#0a0a0f]">
      <section className="container mx-auto p-6 py-14 max-w-4xl">
        <div className="text-slate-200 leading-relaxed text-left">

          <h1 className="text-4xl font-bold mb-2 text-white">Privacy Policy</h1>
          <p className="text-slate-400 mb-10">
            <strong className="text-slate-300">Effective date:</strong> October 9, 2023 &nbsp;|&nbsp;{' '}
            <strong className="text-slate-300">Last updated:</strong> April 7, 2026
          </p>
